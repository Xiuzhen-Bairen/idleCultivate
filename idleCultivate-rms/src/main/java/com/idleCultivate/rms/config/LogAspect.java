package com.idleCultivate.rms.config;

import com.alibaba.fastjson.JSON;
import com.idleCultivate.admin.model.SysAdmin;
import com.idleCultivate.rms.controller.BaseController;
import com.idleCultivate.rms.vo.RequestLog;
...
public class LogAspect {
    ...
    @Pointcut("execution(public * com.idleCultivate.rms.controller..*.*(..))")
    public void commonPoint() {
    }

    @Pointcut("@annotation(com.idleCultivate.rms.support.annotation.LogResult)")
